...
function loadInitialFile() {
    console.log("Puzzle: loadInitialFile");
  puzzle.srcImage.src = "https://assets.codepen.io/2574552/Mona_Lisa.jpg";
}

function setImageUrl(imageUrl) {
    console.log("Puzzle: setImageUrl", imageUrl);
...
{ // scope for animate
  ...
  animate = function () {
    ...
    if (event) console.log("Puzzle: state", state);
    switch (state) {
      /* initialisation */
      case 0:
        state = 10;
      ...
      case 15:
        ...
        if (event.event == "nbpieces") {
            console.log("Puzzle: setting nbpieces", event.nbpieces);
...
function setPuzzle(newPuzzle) {
    console.log("Puzzle: setting puzzle");
  puzzle = newPuzzle;
}
...
export { loadInitialFile, events, Puzzle, animate, setPuzzle, setImageUrl };